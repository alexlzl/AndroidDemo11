...
public class UrlsUtil implements Serializable {
	...
	/******* 登录接口 ********/
	public static final String login = "app/system/activeCode?";

	/******* 个人信息接口 ********/
	public static final String info = "app/customer/FindCustomerInforById?";

	/** ********/
	public static final String updateInfo = "app/customer/UpdateCustomerById?";

	public static final String addressInfo = "app/region/districtDict?";
	//宠物信息
	public static final String petInfo = "app/pet/petInfo?";
	//更新宠物信息
	public static final String UpdatepetInfo = "app/pet/updatePetInfo?";

	//更新作息時間信息
	public static final String UpdatepetTimeInfo = "app/system/workresttime?";

	//获取宠物品类数据字典
	public static final String VaritypetInfo = "app/petVariety/petVarietyDict?";

	//获取宠物成就
	public static final String AcheveInfo = "app/pet/petAchievement?";

	//上传宠物图片
	public static final String UpdatePetImg = "app/fileupload/file?";

	//获取宠物成就
	public static final String Badhabitnfo = "app/pet/petVice?";

	//获取宠物作息时间
	public static final String alarm_time = "app/system/getworkresttime?";

	//获取宠物段位
	public static final String pet_dan = "app/system/getpetdan?";
	//恶习字典
	public static final String BadhabitDicnfo = "app/pet/petViceDict?";

	//恶习字典
	public static final String BadhabitUpdatenfo = "app/pet/updatePetVice?";

	//1.24.获取首页角色环信账号
	public static final String kfInfo = "app/system/petAppHomeTranstion?";

	//1.24.获取首页角色环信账号
	public static final String kfimInfo = "app/system/petTranstion?";

	/******* 获取版本信息 ********/
	public static final String VersionData = "app/system/version?";
