...
public class ChangeDateDialog extends Dialog implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		vChangeDate = findViewById(R.id.ly_myinfo_changebirth);
		...
		wvYear.addScrollingListener(new OnWheelScrollListener() {
			...
			public void onScrollingFinished(WheelView wheel) {
				...
				mYearAdapter = new CalendarTextAdapter(context, arry_years, setYear(Integer.parseInt(currentText)), maxTextSize, minTextSize);
				wvYear.setVisibleItems(5);
				wvYear.setViewAdapter(mYearAdapter);
				wvMonth.setCurrentItem(setYear(Integer.parseInt(currentText)));
			}
		});
		...
		wvMonth.addScrollingListener(new OnWheelScrollListener() {
			...
			public void onScrollingFinished(WheelView wheel) {
				...
				String currentText = (String) mMonthAdapter.getItemText(wheel.getCurrentItem());
//				setTextviewSize(currentText, mMonthAdapter);
				mMonthAdapter = new CalendarTextAdapter(context, arry_months, setMonth(Integer.parseInt(currentText)), maxTextSize, minTextSize);
				wvMonth.setVisibleItems(5);
				wvMonth.setViewAdapter(mMonthAdapter);
				wvMonth.setCurrentItem(setMonth(Integer.parseInt(currentText)));
			}
		});
		...
		wvDay.addScrollingListener(new OnWheelScrollListener() {
			...
			public void onScrollingFinished(WheelView wheel) {
				...
				String currentText = (String) mDaydapter.getItemText(wheel.getCurrentItem());
//				setTextviewSize(currentText, mDaydapter);
				mDaydapter = new CalendarTextAdapter(context, arry_days, Integer.parseInt(currentText) - 1, maxTextSize, minTextSize);
				wvDay.setVisibleItems(5);
				wvDay.setViewAdapter(mDaydapter);
				wvDay.setCurrentItem(Integer.parseInt(currentText) - 1);
			}
		});
	...
	public void initYears() {
		...
		Collections.reverse(arry_years);
	}
	...
	public int setYear(int year) {
		...
		for (int i = 0; i < arry_years.size(); i++) {
			if (Integer.valueOf(arry_years.get(i)) == year) {
				yearIndex = i;
				return yearIndex;
			}
		}
