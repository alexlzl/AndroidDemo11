...
public class AddBadHabitActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        userid =  GetUserId();
        //获取宠物恶习字典
//        ApiHttpCilent.getInstance(mactivty).PetHabitDicInfo(mactivty, userid,new MyCallBack());
        GetHabitDic();
    }
...
//    class MyCallBack extends BaseJsonHttpResponseHandler<BadHabitDicBean> {
//        @Override
//        public void onSuccess(int statusCode, Header[] headers, String rawJsonResponse, BadHabitDicBean response) {
//            Dimess();
//        }
//
//        @Override
//        public void onFailure(int statusCode, Header[] headers, Throwable throwable, String rawJsonData, BadHabitDicBean errorResponse) {
//            Dimess();
//            Message message = Message.obtain();
//            message.what = ConstantsUtil.CONTENT_FAIL;// 错误
//            message.obj = "数据错误,请稍后重试";
...
//
//        @Override
//        protected BadHabitDicBean parseResponse(String rawJsonData, boolean isFailure) throws Throwable {
//            Dimess();
//            Gson gson = new Gson();
//            badHabitDicBean = gson.fromJson(rawJsonData, BadHabitDicBean.class);
//            Message message = Message.obtain();
//            if("1".equals(badHabitDicBean.getStatus())) {
//                message.what = ConstantsUtil.CONTENT_SUCCESS;
//                message.obj = badHabitDicBean.getResult();
...
//            }
//            handler.sendMessage(message);
//            return badHabitDicBean;
//        }
//    }

    class MyUpdateCallBack extends BaseJsonHttpResponseHandler<BaseBean> {
        @Override
        ...
        protected BaseBean parseResponse(String rawJsonData, boolean isFailure) throws Throwable {
            Dimess();
            Gson gson = new Gson();
            BaseBean  baseBean = gson.fromJson(rawJsonData, BaseBean.class);
            Message message = Message.obtain();
